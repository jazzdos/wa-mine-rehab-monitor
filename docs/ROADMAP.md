...
| 4 | **Batch F context**: DBCA-060 fire overlap (three-state, never inferred absence) and SILO climate joined to trajectories | SILO account does not exist (O7); DBCA mirror route blocked pending evidence adjudication | D13 §5 |
